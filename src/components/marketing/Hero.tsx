...
export function Hero() {
  ...
  return (
    <section className="bg-hero py-4 m-6.5">
      <div className="mx-auto grid max-w-site grid-cols-12 gap-6">
        <Card className="col-span-12  p-[80px_64px] max-lg:p-[56px_40px] max-sm:p-[40px_24px] w-full mx-auto max-w-[var(--max-width-card)] border border-[var(--color-border-soft)]">
          <div className="flex flex-col items-center gap-10 md:flex-row md:items-center md:gap-16">
            <div className="flex flex-col gap-16 text-center max-md:gap-10 md:flex-[6]">
              <h1 className="m-0 font-display text-[1.75rem] font-bold leading-9 text-body lg:text-[2.5rem] lg:leading-[3rem]  text-left">
                Custom software,
                <br />
            ...
            <div className="w-full max-w-[420px] md:max-w-none md:flex-[4]">
              <div className="relative mx-auto w-full max-w-[180px] lg:max-w-none lg:flex-1">
                <Image
                  src="/hero_logo.webp"
